    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="hero-section flex-grow flex items-center justify-center">
        <div className="text-center">
          <h1 className="heading-primary text-4xl mb-4">Welcome to My Website</h1>
          <p className="text-secondary text-xl">I'm a passionate developer building amazing things</p>
        </div>
      </section>
      ...
      <section id="about" className="section-light py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="heading-primary text-3xl text-center mb-12">About Me</h2>
          <p className="text-secondary text-lg text-center max-w-3xl mx-auto">
      ...
      <section id="projects" className="section-dark py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="heading-primary text-3xl text-center mb-12">My Projects</h2>
      ...
      <section id="contact" className="section-light py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="heading-primary text-3xl text-center mb-12">Get in Touch</h2>
          <div className="max-w-md mx-auto">
            ...
            <div className="flex justify-center space-x-6">
              ...
              <a href="https://linkedin.com/in/yourusername" target="_blank" rel="noopener noreferrer" className="link">
                LinkedIn
              </a>
            </div>
          </div>
